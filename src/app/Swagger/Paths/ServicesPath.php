...
class ServicesPath
{
    #[OA\Get(
        ...
        description: "Доступно админу базы. Возвращает дополнительные услуги отеля из bc_addetional_prices.",
    ...
    #[OA\Get(
        ...
        description: "Доступно админу базы. Системные услуги из bc_addetional_prices (is_system = true), например «Питание».",
        summary: "Список установленных системных услуг",
        security: [['bearerAuth' => []]],
        tags: ["Services"],
        responses: [
            new OA\Response(
    ...
    #[OA\Get(
        path: "/api/" . ApiConfig::VERSION . "/services/additional-systems",
        description: "Доступно админу базы. Список из таблицы bc_additional_systems (id, name).",
        summary: "Список additional-systems",
        security: [['bearerAuth' => []]],
        tags: ["Services"],
        responses: [
            new OA\Response(
                response: 200,
                description: "Список записей bc_additional_systems",
                content: new OA\JsonContent(
                    required: ["success", "message", "data"],
                    properties: [
                        new OA\Property(property: "success", type: "boolean", example: true),
                        ...
                        new OA\Property(
                            ...
                            items: new OA\Items(
                                ...
                                properties: [
                                    new OA\Property(property: "id", type: "integer", example: 1),
                                    new OA\Property(property: "name", type: "string", example: "Пример"),
                                ],
                                type: "object"
                            )
                        ),
    ...
    public function additionalSystemsIndex(): void
    {
    }

    #[OA\Post(
        path: "/api/" . ApiConfig::VERSION . "/services/additionals",
        description: "Создаёт дополнительную услугу каталога. Доступно админу базы.",
