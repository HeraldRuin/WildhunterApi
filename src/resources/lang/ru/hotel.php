...
return [
    ...
    'validation' => [
        ...
        'hunting_method_ids_must_be_array' => 'Поле «способы охоты» должно быть массивом.',
        'hunting_method_id_must_be_integer' => 'Каждый идентификатор способа охоты должен быть целым числом.',
        'hunting_method_id_not_exists' => 'Один или несколько указанных способов охоты не существуют.',
