...
return [
    ...
    'validation' => [
        ...
        'max_hunters_count_required' => 'Укажите максимальное количество охотников',
        'max_hunters_count_must_be_integer' => 'Максимальное количество охотников должно быть числом',
        'max_hunters_min_value' => 'Максимальное количество охотников — не меньше 1',
        'max_hunters_gte_hunters' => 'Максимальное количество охотников не может быть меньше минимального',
        'animals_required' => 'Укажите список животных',
        'animals_must_be_array' => 'Список животных должен быть массивом',
        'animals_min' => 'Список животных не может быть пустым',
